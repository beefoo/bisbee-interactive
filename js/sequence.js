var SequenceMain = [
  {
    ...
    pauseAmount: 0.1,
    animations: [{prop: 'left', start: -100, end: 50, unit: '%'}],
    sounds: [
    ...
    pauseAmount: 0.1,
    animations: [{prop: 'right', start: -100, end: 50, unit: '%'}],
    sounds: [
      {name: 'door-in', p: 0.2, played: false, direction: [-1, 1]},
      {name: 'door-out', p: 0.7, played: false, direction: [-1, 1]}
    ],
    ...
    pauseAmount: 0.1,
    animations: [{prop: 'top', start: -100, end: 50, unit: '%'}],
    sounds: [
      {name: 'door-in', p: 0.2, played: false, direction: [-1, 1]},
      {name: 'door-out', p: 0.7, played: false, direction: [-1, 1]},
    ...
    tweenMethod: 'none',
    animations: [{prop: 'opacity', start: 0, end: 1, unit: ''}],
    onStart: function(){
    ...
    animations: [{prop: 'right', start: -100, end: 0, unit: '%'}]
  },{
    el: 'rocks-rock1-from-left',
    start: '0:13',
    end: '0:25.6',
    animations: [{prop: 'left', start: -100, end: 0, unit: '%'}],
    sounds: [
    ...
    animations: [{prop: 'top', start: -100, end: 0, unit: '%'}],
    ...
    animations: [{prop: 'top', start: -100, end: 33, unit: '%'}],
    sounds: [
    ...
    animations: [{prop: 'left', start: -100, end: 25.5, unit: '%'}]
  },{
    el: 'ramshackle-tire',
    start: '0:20.2',
    end: '0:35',
    animations: [{prop: 'left', start: -100, end: 20, unit: '%'}]
  },{
    ...
    animations: [{prop: 'top', start: -100, end: 74.2, unit: '%'}]
  },{
    el: 'ramshackle-ball',
    start: '0:21.8',
    end: '0:32.8',
    animations: [{prop: 'top', start: -100, end: 80, unit: '%'}]
  },{
    el: 'ramshackle-plate',
    start: '0:22',
    end: '0:33',
    animations: [{prop: 'top', start: -100, end: 76, unit: '%'}]
  },{
    ...
    animations: [{prop: 'bottom', start: -100, end: 54, unit: '%'}]
  },{
    el: 'homes-hill-bg',
    start: '0:24',
    end: '0:56',
    ...
    animations: [{prop: 'left', start: -100, end: 13, unit: '%'}]
  },{
    ...
    animations: [{prop: 'left', start: -100, end: 33, unit: '%'}]
  },{
    el:'homes-stairwell',
    start: '0:32.5',
    end: '0:43.5',
    animations: [{prop: 'right', start: -100, end: 20, unit: '%'}]
  },{
    el:'homes-foundation',
    start: '0:33',
    end: '0:43',
    animations: [{prop: 'right', start: -100, end: 30, unit: '%'}]
  },{
    el:'homes-shed',
    start: '0:33.5',
    end: '0:42.5',
    animations: [{prop: 'bottom', start: -100, end: 63, unit: '%'}]
  },{
    el:'homes-car-garage',
    start: '0:33.6',
    end: '0:42.4',
    animations: [{prop: 'top', start: -100, end: 58, unit: '%'}]
  },{
    el:'homes-car',
    start: '0:33.8',
    end: '0:42.2',
    animations: [{prop: 'top', start: -100, end: 65, unit: '%'}]
  },{
    ...
    animations: [{prop: 'bottom', start: -100, end: 30, unit: '%'}]
  },{
    el: 'buildings-left',
    start: '0:38',
    end: '0:52',
    ...
    animations: [{prop: 'bottom', start: -100, end: 4.5, unit: '%'}]
  },{
    el: 'buildings-cacti',
    start: '0:40',
    end: '0:50',
    animations: [{prop: 'bottom', start: -100, end: 0, unit: '%'}]
  },{
    el: 'buildings-plant',
    start: '0:40.5',
    end: '0:49.5',
    ...
    animations: [{prop: 'top', start: -100, end: 45, unit: '%'}]
  },{
    el: 'buildings-wires',
    start: '0:41.5',
    end: '0:48.5',
    ...
    animations: [{prop: 'right', start: -100, end: 4.5, unit: '%'}],
    sounds: [
    ...
    animations: [{prop: 'bottom', start: -100, end: 24, unit: '%'}]
  },{
    el: 'pit-barb-wire',
    start: '0:51',
    end: '0:59',
    ...
    animations: [{prop: 'left', start: -100, end: 4.3, unit: '%'}]
  }
];
